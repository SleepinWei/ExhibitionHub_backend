...
public class ResetPasswordController {
    ...
    public boolean isExistByEmail(String email) {// 根据用户email查找用户信息
    ...
    public int sendVerCodeMail(@PathVariable String email) {
        System.out.print(email);

        boolean isExist = this.isExistByEmail(email);
